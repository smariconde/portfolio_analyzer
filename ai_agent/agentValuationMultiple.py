            ...
            (
                "human",
                 f"""Based on the company below, provide the data for the valuation model.
                   ...
                   Only include the revenue_cagr, profit_margin_{target_year}, pe_ratio_{target_year}, shares_reduction_per_year and discount_rate in your JSON output.
...
if __name__ == "__main__":
    ...
    ticker = st.text_input("Enter Ticker", "AAPL", max_chars=5)

    if st.button("Get Valuation", type="secondary"):
